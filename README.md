# Commerce com MongoDB

## Funcionalidades

Métodos e operadores para alterar dados no MongoDB, colocá-los em prática em mais um projeto.

Para esse projeto, foi escolhido um dataset pequeno.
...
Alterar os dados que você inseriu em um banco de dados.

Com MongoDB, você com certeza precisará trabalhar com arrays, que, como você viu até aqui, são uma estrutura muito importante. Através de updates, você conseguirá não só atualizar esses arrays como também inserir novos dados, utilizando os fantásticos operadores do MongoDB.
...
A organização do seu código. Lembre-se de que, mesmo sem schema, é importante padronizarmos as coisas. Em especial, é importante utilizar o conceito de Camel Case, em que a primeira letra em um nome deve ser minúscula, e a primeira letra de cada palavra concatenada deve ser maiúscula.
